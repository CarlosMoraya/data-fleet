...
export function maintenanceFromRow(row: MaintenanceOrderRow): MaintenanceOrder {
  return {
    ...
    budgetOverrideReason: row.budget_override_reason || undefined,
    budgetOverrideById: row.budget_override_by_id || undefined,
    budgetOverrideAt: row.budget_override_at || undefined,
    budgetOverrideByName: row.budget_override_by?.name || undefined,
