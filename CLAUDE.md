...
- **Módulo de Checklists (NOVO)**: Implementado módulo completo com 7 tabelas Supabase (+ seed ~45 itens), 4 mappers TypeScript, 6 componentes React e 4 páginas novas:
  - Templates com ciclo draft → published → deprecated, versionamento, categorias de veículo + "Livre" (100% customizável)
